            ...
            <div className="mt-8 flex items-center justify-around">
                <div className="flex-1 flex flex-col items-center justify-center">
                    ...
                    <div className="mt-4 bg-green-100 w-32 h-32 flex items-center justify-center rounded-full hover:scale-110 transition-transform duration-300">
                        <Icon iconName="fa-user-group" className=" text-orange-500 text-5xl"></Icon>
                    </div>
                </div>
                ...
                <div className="flex-1 flex flex-col items-center justify-center">
                    ...
                    <div className="mt-4 bg-green-100 w-32 h-32 flex items-center justify-center rounded-full hover:scale-110 transition-transform duration-300">
                        <Icon iconName="fa-jet-fighter" className=" text-blue-500 text-5xl"></Icon>
                    </div>
                </div>
                ...
                <div className="flex-1 flex flex-col items-center justify-center">
                    ...
                    <div className="mt-4 bg-green-100 w-32 h-32 flex items-center justify-center rounded-full hover:scale-110 transition-transform duration-300">
                        <Icon iconName="fa-trophy" className=" text-yellow-500 text-5xl"></Icon>
                    </div>
                </div>
            </div>
        </div>
